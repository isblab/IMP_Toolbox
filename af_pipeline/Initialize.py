...
class Initialize(AfParser):
    ...
    def get_attributes(self):
        ...
        self.data = self.dataparser.get_data_dict()
        self.token_chain_ids = self.dataparser.get_token_chain_ids(data=self.data)
        self.token_res_ids = self.dataparser.get_token_res_ids(data=self.data)
        self.pae = self.dataparser.get_pae(data=self.data)
        self.avg_pae = self.dataparser.get_avg_pae(pae=self.pae)
        self.lengths_dict = self.dataparser.get_chain_lengths(data=self.data)
