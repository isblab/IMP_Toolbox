...
def parse_sha256_file(sha256_file_path: str) -> dict:
    ...
    - **sha256_file_path (str)**:<br />
        Path to the SHA256 checksum file.

    ## Returns:

    - **dict**:<br />
        A dictionary mapping file names to their SHA256 checksums.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Verify SHA256 checksum of a file."
    )
    parser.add_argument(
        "--file_path",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="SHA256SUM",
        help="Path to the SHA256 checksum file."
    )

    args = parser.parse_args()

    expected_checksums = parse_sha256_file(sha256_file_path=args.sha256_file)
