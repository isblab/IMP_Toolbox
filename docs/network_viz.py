...
IGNORE_SUBMODULES = [
    f"/home/{_user}/Projects/IMP_Toolbox/docs",
    f"/home/{_user}/Projects/IMP_Toolbox/tests",
]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--analyse_dirs",
        nargs='*',
        default=[f"/home/{_user}/Projects/IMP_Toolbox"],
    ...
    parser.add_argument(
        "--module_dirs",
        nargs='*',
        default=[f"/home/{_user}/Projects/IMP_Toolbox/IMP_Toolbox"],
    ...
    parser.add_argument(
        "--repository_names",
        nargs="*",
        default=["IMP_Toolbox:IMP_Toolbox"],
    ...
    parser.add_argument(
        "--output_path",
        type=str,
        default=f"/home/{_user}/Projects/IMP_Toolbox/docs/network/IMP_Toolbox_network.html",
    ...
    parser.add_argument(
        "--template_directory",
        type=str,
        default=f"/home/{_user}/Projects/IMP_Toolbox/docs/template",
